...
munujoue.addEventListener('click' , ()=>{
    ...
    Joueurs.players.forEach(Element =>{
        joueurs.innerHTML +=`<div class="cardplayer ${"bg" + Element.position} relative w-[7rem] h-[10rem] md:w-[10rem] md:h-[14rem] lg:w-[12rem] lg:h-[17rem] hover:scale-95 flex flex-col  items-center py-4 md:py-7">
